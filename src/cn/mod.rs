pub mod complex_number {
    ...
    pub fn parse_complex(input: &str) -> ComplexNumber {
        let num = input.trim().trim_end_matches(&['i', 'j']);
        let n: (&str, &str) = num.split_at(num.rfind(&['+', '-']).unwrap());
        ComplexNumber::new(
            n.0.parse::<f64>()
                .expect("ERROR IN PARSING REAL PART OF COMPLEX NUMBER"),
            n.1.parse::<f64>()
                .expect("ERROR IN PARSING IMAGINARY PART OF COMPLEX NUMBER"),
        )
    }
    ...
    pub mod testing {
        ...
        #[allow(unused)]
        pub fn test_CN() {
            let u = super::ComplexNumber::new(2_f64, -1_f64);
            let w = super::ComplexNumber::new(2_f64, -1_f64);
            let v = super::ComplexNumber::new(3_f64, 6_f64);
        ...
        pub fn test_file_io() {
            ...
            super::write_data("out_data.dat");
            super::read_data("out_data.dat");
            super::read_complex_data("complex_data.dat");
        ...
        pub fn test_CN_parsing() {
            let u = super::parse_complex("    +3.42-1.213j   ");
            println!(
